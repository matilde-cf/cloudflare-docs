...
This response is commonly returned when a document editor **saves** an action to the origin server, letting the client know the save was successful.
...
This response occurs after someone submits a form or other data and lets the client know to refresh the page or allow another submission.

### Cloudflare-specific information

205 responses must not contain any payloas and Cloudflare does not cache these responses.
